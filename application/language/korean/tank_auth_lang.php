...
// Errors
$lang['auth_incorrect_password'] = '올바른 비밀번호가 아닙니다';
$lang['auth_incorrect_login'] = '올바른 계정이 아닙니다.';
$lang['auth_incorrect_email_or_username'] = '올바른 정보를 입력해주세요.';
$lang['auth_email_in_use'] = '이미 존재하는 이메일 입니다.';
$lang['auth_username_in_use'] = '이미 존재하는 계정입니다.';
$lang['auth_current_email'] = '당신의 이메일 주소 입니다.';
$lang['auth_incorrect_captcha'] = '그림의 문자를 정확히 입력해주세요.';
$lang['auth_captcha_expired'] = '문자 입력 시간이 지났습니다. 다시 시도해주세요.';

// Notifications
$lang['auth_message_logged_out'] = '성공적으로 로그아웃 되었습니다.';
$lang['auth_message_registration_disabled'] = '회원가입이 불가능한 상태 입니다. 관리자에게 문의해주세요.';
...
// Email subjects
$lang['auth_subject_welcome'] = '반갑습니다! %s!';
$lang['auth_subject_activate'] = '반갑습니다! %s!';
